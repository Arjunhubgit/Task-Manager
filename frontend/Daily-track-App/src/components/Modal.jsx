...
const Modal = ({ children, isOpen, onClose, title }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
            <div className="bg-white rounded-2xl shadow-2xl border border-blue-200 w-full max-w-lg mx-4 animate-fade-in">
                {/* Modal header */}
                <div className="flex items-center justify-between px-6 py-4 border-b border-blue-100 bg-gradient-to-r from-blue-50 to-white rounded-t-2xl">
                    <h3 className="text-xl font-bold text-blue-900 tracking-wide">{title}</h3>
                    <button
                        type="button"
                ...
                {/* Modal body */}
                <div className="px-6 py-6 text-blue-900 bg-white rounded-b-2xl">
                    {children}
                </div>
            </div>
        </div>
