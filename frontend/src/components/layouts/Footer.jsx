...
const Footer = () => {
    ...
    return (
        <footer className="bg-[#0a0a0a] border-t border-gray-800/50 py-3 px-3 sm:px-4 md:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4">
                ...
                {/* Links */}
                <div className="flex flex-wrap justify-center md:justify-end gap-3 sm:gap-6 text-xs sm:text-sm text-gray-400">
